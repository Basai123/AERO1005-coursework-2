...
% This task should be run on its own because the function loops forever
% until it is stopped manually in MATLAB.
...
% Red LED    -> D10
% Sensor     -> A0
% Run this section separately from Task 2 because both functions use
% continuous loops and need to be stopped manually.
